import { BookOpen, CalendarCheck, RefreshCw, Users } from "lucide-react";
      ...
      <div className="flex min-h-80 items-center justify-center p-4">
        <div className="w-full max-w-md rounded-xl border border-slate-200 bg-white p-8 text-center shadow-sm">
          ...
          <p className="mt-2 text-sm text-slate-500">
            Có lỗi xảy ra khi lấy dữ liệu lớp học để điểm danh.
          </p>
    ...
    <div className="space-y-6 p-4 sm:p-6">
      <header>
        ...
        <p className="mt-1 text-sm text-slate-500">
          Chọn một lớp học để bắt đầu điểm danh
      ...
      {classes.length === 0 ? (
        ...
        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
          {classes.map((classItem) => {
            const canTakeAttendance = classItem.status === "active";
